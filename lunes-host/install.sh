...
DOMAIN="${DOMAIN:-node6.lunes.host}"
PORT="${PORT:-10008}"
UUID="${UUID:-2584b733-9095-4bec-a7d5-62b473540f7a}"
HY2_PASSWORD="${HY2_PASSWORD:-rhicking.HY2.Password}"

curl -sSL -o app.js https://raw.githubusercontent.com/rhicking/node-one/refs/heads/main/lunes-host/app.js
curl -sSL -o package.json https://raw.githubusercontent.com/rhicking/node-one/refs/heads/main/lunes-host/package.json
...
mv xray xy
curl -sSL -o config.json https://raw.githubusercontent.com/rhicking/node-one/refs/heads/main/lunes-host/xray-config.json
...
curl -sSL -o config.yaml https://raw.githubusercontent.com/rhicking/node-one/refs/heads/main/lunes-host/hysteria-config.yaml
